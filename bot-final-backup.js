        // Comando para cancelar pedido actual
...
Total: ${userState.data.total ? formatearPrecio(userState.data.total) : 'Por calcular'}
━━━━━━━━━━━━━━━━━\n\n`;
            }
            
            respuesta = `${headerPedido}📱 *MENÚ PRINCIPAL*
        ...
        switch (userState.step) {
            case 'inicio':
                ...
                if (['1', '2', '3'].includes(mensaje)) {
                    userState.step = 'menu_principal';
                    // Procesar el número directamente
                    userStates.set(from, userState);
...
<strong>3</strong> para información</div>
    ...
    <div class="suggestions">
        ...
        <span class="suggestion" onclick="enviarTexto('no')">NO</span>
    </div>
...
app.listen(PORT, () => {
    console.log(`
    ☕☕☕☕☕☕☕☕☕☕☕☕☕☕☕☕☕☕☕☕
    🚀 Bot de WhatsApp iniciado - v2.0 Sin Descuentos
    📍 Puerto: ${PORT}
